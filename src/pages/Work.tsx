...
const Work = () => (
  <div className="min-h-screen bg-background relative overflow-hidden">
    ...
    <main className="relative z-10 flex flex-col items-center justify-center min-h-screen max-w-7xl mx-auto px-6 md:px-12 text-center">
      <span className="text-[11px] font-mono font-bold uppercase tracking-[0.2em] text-emerald-600 mb-4">
        Case Studies
      </span>
      <h1 className="font-serif text-5xl md:text-7xl text-slate-900 tracking-tight leading-[1.1] mb-6">
        Results that <span className="italic text-slate-400">speak volumes.</span>
      </h1>
      <p className="text-lg text-slate-500 max-w-xl mb-10 leading-relaxed">
        See how we've helped founders and teams deploy AI-driven systems that deliver measurable ROI.
      </p>
      <Link to="/">

...
export default function WebDevDesktop({ activePhase = "phase-1", className = "" }: WebDevDesktopProps) {
    ...
    return (
        <div className={`absolute inset-0 items-center justify-center overflow-hidden ${className}`}>

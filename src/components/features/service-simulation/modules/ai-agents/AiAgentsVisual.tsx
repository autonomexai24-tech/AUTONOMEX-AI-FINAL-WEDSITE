...
export default function AiAgentsVisual({ activePhase = "phase-1" }: AiAgentsVisualProps) {
  ...
  return (
    <div
      ...
      style={{
        background: "radial-gradient(ellipse at 60% 40%, #0d1117 0%, #060810 100%)",
        perspective: "1200px",
      }}
    >
        ...
        {isP1 && (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 50%, rgba(239,68,68,0.18) 0%, transparent 65%)",
              }}
            />

            {/* Swirling chaos cards */}
            ...
            >
              ...
              <span className="text-[11px] font-mono tracking-[0.25em] text-red-400 uppercase">
                Manual Chaos
              </span>
            </motion.div>
          </motion.div>
        ...
        {isP3 && (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 50%, rgba(16,185,129,0.2) 0%, transparent 65%)",
              }}
            />

            {/* Central holographic dashboard panel */}
            <motion.div
        ...
        {isP4 && (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 50%, rgba(99,102,241,0.22) 0%, transparent 65%)",
              }}
            />

            {/* 4×4 isometric grid of nodes */}
            <motion.div
              ...
              {GRID.map((i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: "0 0 18px rgba(99,102,241,0.2), inset 0 1px 0 rgba(255,255,255,0.05)",
                  }}
                  animate={{
                    boxShadow: [
                  ...
                  transition={{
                    ...
                    repeat: Infinity,
                    ease: "easeInOut",
                    delay: (i % 4) * 0.18 + Math.floor(i / 4) * 0.12,
                  }}
                >
            ...
            >
              ...
              <span className="text-[9px] font-mono tracking-[0.3em] text-indigo-400 uppercase mt-0.5">
        ...
        {isCTA && (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 50%, rgba(139,92,246,0.22) 0%, transparent 60%)",
              }}
            />
            ...
            >
              ...
              <span className="text-[11px] font-mono text-indigo-400 mt-1 tracking-widest uppercase">
